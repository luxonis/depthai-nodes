...
# vcpkg examples use 3.20, assuming this as minimum version for vcpkg cmake toolchain
...
if(NOT DEFINED VCPKG_METRICS_FLAG)
    set(VCPKG_METRICS_FLAG "-disableMetrics" CACHE INTERNAL "flag to disable telemetry by default")
endif()
...
function(vcpkg_init)
    ...
    if(VCPKG_EXECUTABLE EQUAL "" OR NOT DEFINED VCPKG_EXECUTABLE)
        ...
        # set path/location variables to expected path; necessary to detect after a CMake cache clean
        ...
        if(NOT VCPKG_TEST_RETVAL EQUAL "0")
            ...
            if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/vcpkg.json")
                cmake_language(DEFER DIRECTORY ~/Downloads CALL vcpkg_manifest_generation_finalize)
...
function(vcpkg_manifest_generation_add_dependency PKG_NAME)
    if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.19)
        ...
        # reset to empty object to avoid collisions and track new packages
