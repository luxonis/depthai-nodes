...
#define UNIMPLEMENTED throw std::runtime_error("TODO unimplemented");
#define UNIMPLEMENTED_V(msg, ...) throw std::runtime_error(fmt::format("TODO unimplemented: {}", fmt::format(msg, ##__VA_ARGS__)));
